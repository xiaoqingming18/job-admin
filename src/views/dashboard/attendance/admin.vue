    ...
    <el-card class="search-card">
      ...
      <el-form :model="queryParams" inline>
        ...
        <el-form-item label="项目">
          <el-select v-model="queryParams.projectId" placeholder="选择项目" clearable filterable @change="handleProjectChange" :disabled="!queryParams.companyId">
            <el-option
...
// 查询参数
const queryParams = reactive<AttendanceQueryParams & { companyId?: number }>({
  companyId: undefined,
  projectId: undefined,
  memberId: undefined,
  status: undefined,
